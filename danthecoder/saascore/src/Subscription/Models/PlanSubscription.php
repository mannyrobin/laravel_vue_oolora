...
use DanTheCoder\SaaSCore\Subscription\SubscriptionAbility;
...
use DanTheCoder\SaaSCore\Subscription\Events\SubscriptionCreated;
use DanTheCoder\SaaSCore\Subscription\Events\SubscriptionRenewed;
use DanTheCoder\SaaSCore\Subscription\Events\SubscriptionCanceled;
use DanTheCoder\SaaSCore\Subscription\Events\SubscriptionPlanChanged;
...
use DanTheCoder\SaaSCore\Subscription\Exceptions\FeatureValueFormatIncompatibleException;
...
class PlanSubscription extends Model implements PlanSubscriptionInterface
{
     ...
     *
     * @var DanTheCoder\SaaSCore\Subscription\SubscriptionAbility
     */
    protected $ability;
    ...
    {
        return $this->hasMany(
            'DanTheCoder\SaaSCore\Subscription\Models\PlanSubscriptionUsage',
            'subscription_id'
        );
    }
     ...
     *
     * @return \DanTheCoder\SaaSCore\Subscription\SubscriptionAbility
     */
