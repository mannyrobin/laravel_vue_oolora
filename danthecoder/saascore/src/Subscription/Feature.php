...
class Feature
{
     ...
     * @throws  \DanTheCoder\SaaSCore\Subscription\Exceptions\InvalidPlanFeatureException
     * @return void
     */
    public function __construct($feature_code)
    {
        ...
        $feature = config('settings.plan_features.'.$feature_code);
    ...
    {
        $features = config('settings.plan_features');
